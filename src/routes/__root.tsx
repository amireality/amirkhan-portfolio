...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Amir Khan, Founder, Vibecoder & Operator" },
      { name: "description", content: "Personal portfolio and command center of Amir Khan, founder of Setupr, operator of ALTERED and Alt, and AI-assisted web builder from Jaipur, India." },
      { name: "author", content: "Amir Khan" },
      { property: "og:title", content: "Amir Khan, Founder, Vibecoder & Operator" },
      { property: "og:description", content: "Personal portfolio and command center of Amir Khan, founder of Setupr, operator of ALTERED and Alt, and AI-assisted web builder from Jaipur, India." },
